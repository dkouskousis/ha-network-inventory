  ...
  renderIntegrations() {
    ...
    return `<section class="section-head"><div><h2>${this.t("integrations")}</h2><p>${this.t("integrationsHelp")}</p></div></section>
      <article class="card integration-card shelly-card">
        <div class="integration-logo shelly-logo"><ha-icon icon="mdi:power-socket-eu"></ha-icon></div>
      ...
      <article class="card integration-card integration-gap reolink-card">
        <div class="integration-logo reolink-logo"><ha-icon icon="mdi:cctv"></ha-icon></div>
        <div class="grow"><div class="integration-title"><h2>Reolink</h2><span class="native-badge reolink-badge">${this.t("nativeIntegration")}</span><span class="status-dot ${reolink.configured ? "ok" : ""}">${reolink.configured ? this.t("reolinkDetected") : this.t("reolinkNotDetected")}</span></div>
